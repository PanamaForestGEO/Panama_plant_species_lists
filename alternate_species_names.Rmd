...
FILEVIEWTAXSYN <- "splists_raw/Forestgeo/2025-12-04FromSuzanne/ViewTaxonomy_dec4_25_SYNONYMS.xlsx"
...
# remove cases in which the two names are the same
altnames <- altnames %>%
...
```
Writing all synonyms to the file `r FILEALLSYN`
