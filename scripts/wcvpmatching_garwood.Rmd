...
if(file.exists(matches_mid_path) & !redoWCVP){
  ...
  matchresult <- wcvp_match_names(subset(origlist,is.na(Prefix)), wcvp_names, name_col = "orig_name")
...
if(file.exists(matches_mid_path2) & !redoWCVP){
  ...
  matchresult2 <- wcvp_match_names(subset(origlist,orig_name!=orig_binomial & is.na(Prefix)), wcvp_names, 
