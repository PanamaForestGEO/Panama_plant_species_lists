...
⚠️ Manually select the species names that need to change and then remove the duplicates:
...
Species removed because they have the same accepted name as another species in the list:

`r paste(current_name_species_merge, collapse="<br>")`
